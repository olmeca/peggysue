...
public class SequenceTest {
    ...
    public void testOneOrMoreSuccess2() throws NoMatchException {
        Pattern ooma = Make.oneOrMoreGivenChar('a');
        Pattern oomb = Make.oneOrMoreGivenChar('b');
        Pattern seqab = Sequence.of(ooma, oomb);
    ...
    public void testLiteralSuccess() throws NoMatchException {
        Pattern literal = new Literal("test");
    ...
    public void testCaptures() throws NoMatchException {
        Pattern ooma = Make.oneOrMoreGivenChar('a').capture("ooma");
        Pattern oomb = Make.oneOrMoreGivenChar('b').capture("oomb");
        Pattern seqab = Sequence.of(ooma, oomb);
        Match match = seqab.match("aabbbc");
        assertEquals(0, match.start);
        assertEquals(5, match.length);
    ...
    @Test
    public void testZeroOrMoreSuccess() throws NoMatchException {
        ZeroOrMore oom = new ZeroOrMore(new GivenChar('a'));
        Match match = oom.match("");
        assertEquals(0, match.start);
    }
}
